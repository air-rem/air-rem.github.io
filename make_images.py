...
def topbar(img, W):
    ...
    d.text((156, 66), "AIRREM", font=font(30, True), fill=INK)
...
def site_og():
    ...
    d.text((80, 536), "air-rem.github.io", font=font(26), fill=MUT)
...
def airport_og(a):
    ...
    # bottom band
    d.line([(80, 512), (1120, 512)], fill=(255, 255, 255, 40), width=1)
    d.text((80, 536), "AIRREM 领航 · 机场评测", font=font(26), fill=MUT)
